...
function AdminAddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/api/sellerProductUpload/products", productData);
      ...
      // show whichever message the server provided (msg or error), fallback to generic
      const serverMsg = error.response?.data?.msg || error.response?.data?.error || error.message;
      setMessage(serverMsg || "Error uploading product. Try again!");
    }
